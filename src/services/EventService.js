...
let url = _spPageContextInfo.webServerRelativeUrl + "/_api/lists/getbytitle('F3I2PMOShared')/items?$select=RecurrenceData,MasterSeriesItemID,EventType,*"
// let url = _spPageContextInfo.webServerRelativeUrl + "/_api/lists/getbytitle('F3I2PMOShared')/items"
// let url = _spPageContextInfo.webServerRelativeUrl + "/_api/web/lists/getbytitle('F3I2PMOShared')/GetItems"
let isostart = moment().add(-6, 'M').format()
let isoend = moment().add(6, 'M').format()
...
caml += "<ViewFields><FieldRef Name='Title' /><FieldRef Name='EventDate' /><FieldRef Name='Description' /><FieldRef Name='EndDate' /><FieldRef Name='Location' /><FieldRef Name='Author' /><FieldRef Name='EventType' /><FieldRef Name='Duration' /><FieldRef Name='Category' /><FieldRef Name='RecurrenceID' /><FieldRef Name='fRecurrence' /><FieldRef Name='RecurrenceData' /></ViewFields></View>"
