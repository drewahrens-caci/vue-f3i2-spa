<template>
  <div>
    ...
    <b-modal id="MsrForm" ref="MsrForm" @close="onModalHide" no-close-on-esc no-close-on-backdrop no-fade hide-backdrop :title="dialogTitle" footer-bg-variant="warning" header-bg-variant="warning" modal-class="msr-modal" dialog-class="msr-dialog" content-class="msr-content" body-class="msr-body" v-model="Show" scrollable @shown="onModalShown">
        ...
        <b-container fluid class="p-0 m-0">
          <b-row>
            ...
            <b-col cols="4" class="p-0 text-right">
              <b-button-group class="mt-1">
                <b-button variant="danger" ref="btnCancel" class="mr-2" @click="onModalHide">Close MSR</b-button>
              </b-button-group>
            </b-col>
          </b-row>
        </b-container>
...
export default {
  ...
  methods: {
    ...
    onModalShown: function() {
      this.dialogTitle = 'Edit Data For MSR ' + this.msrdata.WorkplanTitle
    ...
    getFormStatus: function() {
      ...
      if (this.isDirty) {
        this.$cron.restart(this.getFormStatus)
      } else {
    ...
    onModalHide: function() {
      ...
      MSR.dispatch('updateMSRData', payload)
      this.$emit('close')
    },
